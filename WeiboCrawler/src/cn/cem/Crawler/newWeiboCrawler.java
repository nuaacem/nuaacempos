...
//			HtmlPage page = client.getPage(searchString + i);
			String aString=httpClient.CookieCrawler(searchString + i);
			System.out.println("page:" + i);
			collectInfo(aString,keyword);
		}
	}
	 ...
	 * @throws IOException
	 */
	private static void collectInfo(String aString,String keyWord)
			throws FailingHttpStatusCodeException, MalformedURLException,
			IOException {
