...
<div class="header navbar navbar-inverse navbar-fixed-top">
  ...
  <div class="header-inner">
     <!-- BEGIN LOGO -->  
     <a class="navbar-brand" href="/nuaacempos">
		&nbsp;&nbsp;&nbsp;nuaacempos
     </a>
     ...
     <ul class="nav navbar-nav pull-right">
       <!--  <li class="devider">&nbsp;</li> -->
        ...
        <li class="dropdown user">
           ...
           <span class="username">${sessionScope.accountAuth.username}</span>&nbsp;-&nbsp;
           ...
           <ul class="dropdown-menu">
              ...
              <li><a href="/nuaacempos/account/logout"><i class="icon-off"></i>注销登录</a>
              </li>
           </ul>
        </li>
