...
<body class="login">
	...
	<div class="content">
		...
		<form:form modelAttribute="contentModel" class="register-form" method="POST">
			...
			<div class="form-group">
				...
				<div class="input-icon">
					<i class="icon-envelope"></i>
					<form:input path="mobile" class="form-control placeholder-no-fix" autocomplete="off" placeholder="手机"/><br/>
	...
	<!-- BEGIN COPYRIGHT -->
	<div class="copyright">
    	2015 &copy; Nuaa 信息管理与电子商务研究所舆情小组.
	</div>
	<!-- END COPYRIGHT -->
